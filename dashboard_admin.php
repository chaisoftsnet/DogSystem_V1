...
<div class="container">
  ...
  <div class="dashboard">
    <div class="card-glass">
      ...
      <a href="dog_update.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="treatment_manage.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="appointment_manage.php?Mode=<?=$Mode?>">จัดการนัดหมาย</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="vaccine_manage.php?Mode=<?=$Mode?>">จัดการวัคซีน</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="deworming_manage.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="LabResults_manage.php?Mode=<?=$Mode?>">จัดการผลตรวจ</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="Surgeries_manage.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="Nutrition_manage.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="boarding_manage.php?Mode=<?=$Mode?>">จัดการข้อมูล</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="attachments_manage.php?Mode=<?=$Mode?>">จัดการเอกสาร</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="clinic_update.php?Mode=<?=$Mode?>">ตั้งค่าคลินิก</a>
    </div>
    ...
    <div class="card-glass">
      ...
      <a href="user_update.php?Mode=<?=$Mode?>">ผู้ใช้งานระบบ</a>
    </div>
    <?php endif; ?>
  </div>
